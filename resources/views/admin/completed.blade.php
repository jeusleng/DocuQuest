...
<head>
    ...
    <title>SFHS Admin - Completed Appointments</title>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{ route('admin.completed') }}">Completed</a>
                    </div>
                </div>
            </li>
            <!-- Nav Item - Charts -->
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-0 text-gray-800 text-center"
                        style="color: #c53f3f !important; font-weight: bold;">Completed Appointments</h1><br>
                                            ...
                                            <div class="card-body">
                                                <table class="table table-bordered text-center" id="approved-requests-table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @forelse ($completedAppointments as $request)
                                                            <tr>
                                                                <td>{{ $counter++ }}</td>
