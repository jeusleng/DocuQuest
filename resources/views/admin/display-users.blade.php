...
<head>
    ...
    <title>SFHS Admin - Users Management</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-0 text-gray-800 text-center"
                        style="color: #c53f3f !important; font-weight: bold;">Current
                        Students</h1><br>
                                            ...
                                            <div class="card-body">
                                                <table class="table table-bordered text-center"
                                                    ...
                                                    <tbody>
                                                        @if($students->isEmpty())
                                                        <tr>
                                                            <td colspan="10">There are currently no enrolled students to display at the moment.</td>
                                                        </tr>
                                                        @else
                                                        ...
                                                        <tr>
                                                            ...
                                                            @if ($student->student_type === 'current')
                                                                <td>Student</td>
                                                            @endif
