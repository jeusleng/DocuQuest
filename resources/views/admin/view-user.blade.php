        ...
        <ul class="navbar-nav bg-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUsers" class="collapse show" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item active" href="{{ route('admin.display-users') }}">Current Students</a>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ $currentStudent->first_name }} {{ $currentStudent->last_name }}"
                                                                disabled>
                                                        </div>
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ $currentStudent->contact_number }}" disabled>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <label for="gender">Gender</label>
                                                            <input type="text" class="form-control" id="gender"
                                                                name="gender" value="{{ $currentStudent->gender }}"
                                                                disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ $currentStudent->date_of_birth }}" disabled>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label for="complete_address">Address</label>
                                                            <input type="text" class="form-control"
                                                                id="complete_address" name="complete_address"
                                                                value="{{ $currentStudent->complete_address }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ $currentStudent->grade_level }}" disabled>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <label for="section">Section/Strand</label>
                                                            <input type="text" class="form-control" id="section"
                                                                name="section" value="{{ $currentStudent->section }}"
                                                                disabled>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <label for="email">Email</label>
                                                            <input type="text" class="form-control" id="email"
                                                                name="email" value="{{ $currentStudent->email }}"
                                                                disabled>
                                                        </div>
                                                    </div>
                                                </div>
