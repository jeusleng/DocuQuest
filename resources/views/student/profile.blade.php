                    ...
                    <form class="signup-form" method="POST" action="{{ route('profile.update') }}">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control" id="grade_level" name="grade_level">
                                <option value="7" {{ $user->grade_level == 7 ? 'selected' : '' }}>Grade 7</option>
                                <option value="8" {{ $user->grade_level == 8 ? 'selected' : '' }}>Grade 8</option>
                                <option value="9" {{ $user->grade_level == 9 ? 'selected' : '' }}>Grade 9</option>
                                <option value="10" {{ $user->grade_level == 10 ? 'selected' : '' }}>Grade 10</option>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" id="learner_reference_number" name="learner_reference_number" value="{{ $user->learner_reference_number }}">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="graduation_year" name="graduation_year" value="{{ $user->graduation_year }}">
                            </div>
                            <!-- Last Grade Attended -->
                            <div class="form-group col-md-6">
                                <label for="last_grade_attended">Last Grade Attended</label>
                                <input type="text" class="form-control" id="last_grade_attended" name="last_grade_attended" value="{{ $user->last_grade_attended }}">
                            </div>
                        </div>
                        <div class="form-row">
                            <!-- Adviser's Name -->
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="adviser_name" name="adviser_name" value="{{ $user->adviser_name }}">
                            </div>
                            <!-- Adviser's Section -->
                            <div class="form-group col-md-6">
                                <label for="adviser_section">Section</label>
                                <input type="text" class="form-control" id="adviser_section" name="adviser_section" value="{{ $user->adviser_section }}">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="guardian_full_name" name="guardian_full_name" value="{{ $user->guardian_full_name }}">
                            </div>
                            <!-- Guardian's Contact Number -->
                            <div class="form-group col-md-6">
                                <label for="guardian_contact_number">Guardian's Contact Number</label>
                                <input type="text" class="form-control" id="guardian_contact_number" name="guardian_contact_number" value="{{ $user->guardian_contact_number }}">
                            </div>
                        </div>
